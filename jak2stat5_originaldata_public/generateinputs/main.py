...
# run this script to generate all necessary simulations for model analysis - this should be the first script run!
...
totalchain = np.concatenate((chain1, chain2, chain3, chain4, chain5), axis=0)
...
posteriorsamples_thinned = np.load('generateinputs/all_chains_baseline_proposal 0.1_thinnedestimatedvariables.npy')
